...
<nav class="navbar">
    ...
    <div class="navbar-right">
        ...
        <div class="bell-wrapper" id="bellWrapper">
            <div class="nav-icon" id="bellBtn" onclick="toggleNotif(event)" style="position:relative;">
                <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                    <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/>
                    <path d="M13.73 21a2 2 0 0 1-3.46 0"/>
                </svg>
                <span class="bell-badge" id="bellBadge">7</span>
            </div>
            ...
            <div class="notif-panel" id="notifPanel">
                ...
                <div class="notif-list">
                    ...
                    <div class="notif-item">
                        <div class="notif-dot green"><div class="notif-dot-inner"></div></div>
                        <div class="notif-content">
                            <div class="notif-title">Pembayaran berhasil</div>
                            <div class="notif-desc">Kamar 101</div>
                            <div class="notif-time">2 menit yang lalu</div>
                        </div>
                    </div>

                    <div class="notif-item">
                        <div class="notif-dot blue"><div class="notif-dot-inner"></div></div>
                        <div class="notif-content">
                            <div class="notif-title">Booking baru</div>
                            <div class="notif-desc">Ilham syaid memesan kamar nomor 101</div>
                    ...
                    <div class="notif-item">
                        <div class="notif-dot green"><div class="notif-dot-inner"></div></div>
                        <div class="notif-content">
                            <div class="notif-title">Data Berhasil di Tambahkan</div>
                            <div class="notif-desc">Kamar 207 berhasil di buat</div>
                            <div class="notif-time">24 Juni 2026</div>
                        </div>
                    </div>

                    <div class="notif-item">
                        <div class="notif-dot red"><div class="notif-dot-inner"></div></div>
                        <div class="notif-content">
                            <div class="notif-title">Gagal Menyimpan Data</div>
                            <div class="notif-desc">Terjadi kesalahan saat memperbaru data kamar.</div>
                            <div class="notif-time">24 Juni 2026</div>
                        </div>
                    </div>

                    <div class="notif-date-sep">27 Mei 2027</div>

                    <div class="notif-item">
                        <div class="notif-dot green"><div class="notif-dot-inner"></div></div>
                        <div class="notif-content">
                            <div class="notif-title">Data Berhasil di Hapus</div>
                            <div class="notif-desc">Data kamar 205 berhasil dihapus dari sistem.</div>
                            <div class="notif-time">27 Mei 2027</div>
                        </div>
                    </div>
                    ...
                    <div class="notif-item">
                        <div class="notif-dot red"><div class="notif-dot-inner"></div></div>
                        <div class="notif-content">
                            <div class="notif-title">Gagal Menghapus Data</div>
                            <div class="notif-desc">Terjadi kesalahan saat menghapus data kamar.</div>
                            <div class="notif-time">27 Mei 2027</div>
                        </div>
                    </div>

                    <div class="notif-item">
                        <div class="notif-dot yellow"><div class="notif-dot-inner"></div></div>
                        <div class="notif-content">
                            <div class="notif-title">Koneksi Database Tidak Stabil</div>
                            <div class="notif-desc">Beberapa layanan mungkin mengalami keterlambatan.</div>
                            <div class="notif-time">24 Mei 2027</div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function markAllRead() {
        ...
        document.querySelectorAll('.notif-dot').forEach(dot => dot.style.opacity = '0.3');
    }
</script>
