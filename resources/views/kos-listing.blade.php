        ...
        <a href="/" class="brand-wrap">
            <div class="brand-logo">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8 38V20L24 10L40 20V38" stroke="#3A5540" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <rect x="16" y="24" width="16" height="14" rx="1" stroke="#3A5540" stroke-width="2"/>
                    <path d="M22 38V30H26V38" stroke="#3A5540" stroke-width="2"/>
                    <path d="M18 18L24 14L30 18" stroke="#6B8F71" stroke-width="2" stroke-linecap="round"/>
                </svg>
            </div>
