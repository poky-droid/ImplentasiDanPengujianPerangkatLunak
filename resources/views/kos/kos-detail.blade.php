        ...
        <div class="layout">
            ...
            <div class="left-col">
                ...
                <div class="gallery" aria-label="Gallery">
                    @if($count === 0)
                        <!-- No images: show three placeholders (main + two thumbs) -->
                        ...
                        <div class="gallery-thumb">
                            <div class="img-placeholder img-placeholder-bath"></div>
                        </div>
                        <div class="gallery-thumb">
                            <div class="img-placeholder img-placeholder-room"></div>
                        </div>

                    @elseif($count === 1)
                        <!-- Single image: use full width (make the main take full grid) -->
                        <div class="gallery-main" style="grid-column:1 / -1; grid-row: 1 / 2;">
                            <img src="{{ $images[0] }}" alt="Foto {{ $kos->nama }}">
                        </div>

                    @elseif($count === 2)
                        <!-- Two images: split in two equal columns -->
                        <div class="gallery-main" style="grid-column:1 / 2; grid-row:1 / 2;">
                            <img src="{{ $images[0] }}" alt="Foto {{ $kos->nama }}">
                        </div>
                        <div class="gallery-thumb" style="grid-column:2 / 3; grid-row:1 / 3;">
                            <img src="{{ $images[1] }}" alt="Foto {{ $kos->nama }}">
                        </div>

                    @else
                        <!-- Three or more: left large, right stacked two thumbs -->
                        <div class="gallery-main">
                            <img src="{{ $images[0] }}" alt="Foto utama {{ $kos->nama }}">
                        </div>
                        <div class="gallery-thumb">
                            <img src="{{ $images[1] }}" alt="Foto {{ $kos->nama }}">
                        </div>
                        <div class="gallery-thumb">
                            <img src="{{ $images[2] }}" alt="Foto {{ $kos->nama }}">
                        </div>
                    @endif
                </div>
